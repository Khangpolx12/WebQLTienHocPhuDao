...
{
$errormsg = "<div class='alert alert-success'><strong>Chúc mừng!</strong> Thêm thành công</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><strong>Chúc mừng!</strong> Sửa thành công</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><strong>Chúc mừng!</strong> Xóa thành công</div>";
}
...
<head>
    ...
    <title>Trường THCS Phước Long</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Khối lớp  
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="Thêm" || @$_GET['action']=="edit")?
						' <a href="branch.php" class="btn btn-primary btn-sm pull-right">Trở về <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="branch.php?action=Thêm" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Thêm </a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="Thêm")? "Thêm khối": "Sửa khối"; ?>
                        </div>
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Password"> Tổng tiền </label>
								<div class="col-sm-10">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="Confirm"> Chi tiết</label>
								<div class="col-sm-10">
		...
		$( document ).ready( function () {			
			 ...
			 if($("#signupForm1").length > 0)
         {
			$( "#signupForm1" ).validate( {
				...
				messages: {
					branch: "Hãy nhập khối",
					address: "Hãy nhập tổng tiền"
