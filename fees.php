...
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Chúc mừng!</strong> Đã cập nhật thành công</div>";
}
...
<head>
    ...
    <title>QUẢN LÝ ĐÓNG TIỀN HỌC PHỤ ĐẠO</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">CẬP NHẬT TIỀN HỌC
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Tên/Liên hệ</th><th>Số Tiền</th><th>Số tiền nợ</th><th>Khối</th><th>Ngày</th><th>Chỉnh sửa</th></tr></thead><tbody></tbody></table>');
...
display:none;
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Đóng tiền</h4>
        </div>
    ...
    <div id="footer-sec">
    HỆ THỐNG QUẢN LÝ TIỀN HỌC PHỤ ĐẠO 
    </div>
