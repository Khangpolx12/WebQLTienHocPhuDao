...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Cài đặt</h1>
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
								<label class="col-sm-4 control-label" for="Old">Mật khẩu cũ</label>
								<div class="col-sm-5">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm">Xác thực mật khẩu</label>
								<div class="col-sm-5">
    ...
    <script src="js/custom1.js"></script>
		...
		$( document ).ready( function () {			
			...
			$( "#signupForm1" ).validate( {
				...
				messages: {
					oldpassword: "Hãy nhập mật khẩu cũ của bạn",
					
					newpassword: {
						required: "Hãy nhập mật khẩu mơi",
						minlength: "Mật khẩu của bạn phải dài ít nhất 6 ký tự"
					},
					confirmpassword: {
						required: "Hãy nhập lại mật khẩu",
						minlength: "Mật khẩu của bạn phải dài ít nhất 6 ký tự",
						equalTo: "Hãy nhập giống mật khẩu ở trên"
					}
				},
				errorElement: "em",
