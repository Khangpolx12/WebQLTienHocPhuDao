...
echo '  <form class="form-horizontal" id ="signupForm1" action="fees.php" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Tổng tiền:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Số tiền nợ:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Số tiền trả:</label>
    <div class="col-sm-10">
